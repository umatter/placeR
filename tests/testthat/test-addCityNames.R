test_that("addCityNames function works correctly", {
  ...
  skip_if_not(file.exists(cities))

  # Test the function
  swiss_cities_named <- addCityNames(poly, cities)

  # Check the output
  expect_s4_class(swiss_cities_named, "SpatialPolygonsDataFrame")
  ...
  # Check the output
  expect_s4_class(swiss_cities_named_expand, "SpatialPolygonsDataFrame")
